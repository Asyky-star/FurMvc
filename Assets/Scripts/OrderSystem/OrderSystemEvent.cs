...
namespace OrderSystem
{
    public class OrderSystemEvent
    {
        ...
        /// 通知房间
        /// </summary>
        public const string CALL_Room = "selectRoom";
        /// <summary>
        /// 刷新房间
        /// </summary>
        public const string ReshRooms = "reshroom";
        /// <summary>
        /// 走 command
        /// </summary>
        public const string Rooming = "Rooming";
        /// <summary>
        /// 付房费
        /// </summary>
        public const string Pay_rooms = "fufangfei";
