namespace PureMVC.Patterns
{
    ...
    public class Facade : IFacade
    {
        ...
        public void RegisterCommand(string notificationName, Type commandType)//notificationName = "cookCooking"  commandType = {CookCommend}
        {
            this.m_controller.RegisterCommand(notificationName, commandType); // （star up  starupcomponent）
        }
        ...
        public void SendNotification(string notificationName, object body)//notificationName = "StartUp"  body = "Canvas (OrderSystem.MainUI)"
        {
